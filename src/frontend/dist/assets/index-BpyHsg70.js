...
function Navigation({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-primary shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "EM Waves" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          "data-ocid": `nav.${item.id}.link`,
          onClick: () => handleNav(item.id),
          className: `px-3 py-2 rounded-md text-sm font-medium transition-colors ${currentPage === item.id ? "bg-primary-foreground/10 text-accent font-semibold" : "text-primary-foreground/80 hover:text-primary-foreground hover:bg-primary-foreground/10"}`,
          children: item.label
        },
        item.id
      )) }),
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "lg:hidden pb-4 flex flex-col gap-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        "data-ocid": `nav.mobile.${item.id}.link`,
        onClick: () => handleNav(item.id),
        className: `w-full text-left px-4 py-2 rounded-md text-sm font-medium transition-colors ${currentPage === item.id ? "bg-primary-foreground/10 text-accent font-semibold" : "text-primary-foreground/80 hover:text-primary-foreground"}`,
        children: item.label
      },
      item.id
    )) })
...
function AboutMe({ onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "about.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        "data-ocid": "about.section",
        className: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-20 px-4",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl flex flex-col md:flex-row items-center gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-40 h-40 rounded-full bg-accent/20 border-4 border-accent flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-5xl font-bold text-accent", children: "TJ" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent font-semibold text-sm uppercase tracking-widest mb-2", children: "Educator & Technologist" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl font-bold mb-3", children: "Talari Jyothsna" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg mb-4", children: "9 Years of Combined Experience in IT Industry & Education" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center md:justify-start", children: qualifications.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container mx-auto max-w-4xl px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-4", children: "About Me" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "I am Talari Jyothsna, a passionate educator with a strong foundation in both the IT industry and academic teaching. With a BSc in Computers, BEd, and currently pursuing MEd (3rd Semester), I bring a unique interdisciplinary perspective to the classroom." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "My 9-year journey has spanned software development, educational technology, and classroom instruction — giving me the ability to bridge the gap between theoretical knowledge and practical application." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "I believe that every student deserves engaging, meaningful learning experiences. My teaching philosophy centers on making complex scientific concepts accessible through visual aids, interactive activities, and real-world connections." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-4", children: "Professional Journey" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-5 h-5 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground", children: "IT Industry" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Software development, system analysis, and technology solutions — building a strong technical foundation." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-5 h-5 text-accent-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground", children: "Education Sector" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Teaching Physics and Computer Science, designing curricula, and mentoring students through challenging concepts." })
            ] })
          ] })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary py-12 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-8 text-center", children: "Areas of Expertise" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: expertise.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "wave-card shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4 text-primary", children: item.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg mb-2", children: item.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: item.desc })
      ] }) }, item.title)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container mx-auto max-w-4xl px-4 py-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-accent/10 border border-accent/30 rounded-2xl p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-3", children: "Current Focus: Electromagnetic Waves" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "This educational website is a lesson plan resource for Physics Class 12, Chapter 8 — Electromagnetic Waves. Explore the pages to learn about Maxwell's discovery, the EM spectrum, and much more." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
...
const strategies = [
  {
    number: 1,
    title: "Demonstration",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-6 h-6" }),
    duration: "20 minutes",
    grouping: "Whole class",
    description: "Show the EM spectrum using a prism and white light. Demonstrate how white light disperses into VIBGYOR and explain where different EM waves sit beyond visible light.",
    instructions: [
  ...
  },
  {
    ...
    duration: "15 minutes",
    grouping: "Pairs",
    description: "Students discuss 'How do microwaves heat food?' in pairs before sharing with the class. This encourages peer learning and deeper conceptual understanding.",
    instructions: [
  ...
  },
  {
    number: 3,
    title: "Mind Mapping",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Network, { className: "w-6 h-6" }),
    duration: "25 minutes",
    grouping: "Small groups (3–4)",
    description: "Create a mind map of all EM wave types and their uses. The central node is 'Electromagnetic Spectrum' branching into each wave type with properties and applications.",
    instructions: [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-6 h-6" }),
    duration: "30 minutes",
    grouping: "Individual / Pairs",
    description: "Analyze real-world applications of EM waves: TV remote controls (infrared), X-ray diagnostics in medicine, and radio communication systems.",
    instructions: [
  ...
  },
  {
    ...
    description: "Each group becomes expert on one type of EM wave and teaches others. Groups study their assigned wave type deeply then regroup to teach the full spectrum.",
    instructions: [
...
function ActivitiesStrategies() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "activities.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/20 text-accent border-accent/40 mb-4", children: "Pedagogy" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl font-bold mb-4", children: "Activities & Teaching Strategies" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg max-w-2xl", children: "Engaging, student-centered approaches to teaching Electromagnetic Waves \\u2014 promoting deeper understanding through active participation." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto max-w-5xl px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: strategies.map((strategy) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        className: `shadow-card border-2 ${strategy.color}`,
        "data-ocid": `activities.item.${strategy.number}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center text-primary flex-shrink-0", children: strategy.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: strategy.badgeColor, children: [
                  "Strategy ",
                  strategy.number
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-xl", children: strategy.title })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-4", children: strategy.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold mb-2", children: "Instructions" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-1", children: strategy.instructions.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    className: "text-sm text-muted-foreground flex gap-2",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-primary flex-shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold mb-2", children: "Learning Outcomes" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: strategy.outcomes.map((outcome) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    className: "text-sm text-muted-foreground flex gap-2",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600 flex-shrink-0", children: "\\u2713" }),
                      outcome
                    ]
                  },
                  outcome
...
function AssessmentReflection() {
  ...
  const [reflectionName, setReflectionName] = reactExports.useState("");
  const [reflectionLearned, setReflectionLearned] = reactExports.useState("");
  const [reflectionRating, setReflectionRating] = reactExports.useState("3");
  const [reflectionQuestions, setReflectionQuestions] = reactExports.useState("");
  const [reflectionSubmitted, setReflectionSubmitted] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "assessment.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/20 text-accent border-accent/40 mb-4", children: "Assessment & Reflection" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl font-bold mb-4", children: "Test Your Knowledge" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg", children: "A 10-question quiz on Electromagnetic Waves, followed by a reflection form to consolidate your learning." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl px-4 py-12 space-y-12", children: [
      submitted && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          "data-ocid": "assessment.success_state",
          className: `rounded-xl p-6 text-center ${score >= 8 ? "bg-green-50 border-2 border-green-400" : score >= 5 ? "bg-amber-50 border-2 border-amber-400" : "bg-red-50 border-2 border-red-400"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-6xl font-display font-bold mb-2", children: [
              score,
              "/10"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold", children: score >= 8 ? "Excellent! 🎉" : score >= 5 ? "Good effort! Keep practicing." : "Keep studying — you've got this!" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "assessment.section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-6", children: "Multiple Choice Quiz" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: quizQuestions.map((q, qIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            className: "shadow-card",
            "data-ocid": `assessment.item.${qIdx + 1}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary mr-2", children: [
                  q.id,
                  "."
                ] }),
                q.question
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: q.options.map((option, optIdx) => {
                const isSelected = answers[q.id] === optIdx;
                const isCorrect = optIdx === q.answer;
                let cls = "quiz-option cursor-pointer flex items-center gap-3 p-3 rounded-lg border transition-colors ";
                if (!submitted) {
                  cls += isSelected ? "selected border-primary bg-primary/10" : "border-border hover:bg-secondary";
                } else {
                  if (isCorrect)
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-7 h-7 rounded-full border-2 border-current flex items-center justify-center text-xs font-bold flex-shrink-0", children: String.fromCharCode(65 + optIdx) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-left", children: option }),
                      submitted && isCorrect && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5 text-green-600" }),
                      submitted && isSelected && !isCorrect && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "w-5 h-5 text-red-500" })
                    ]
                  },
                  option
                );
        ...
        !submitted && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-6", children: "Reflection Form" }),
        reflectionSubmitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": "assessment.success_state",
            className: "bg-green-50 border-2 border-green-400 rounded-xl p-8 text-center",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-16 h-16 text-green-500 mx-auto mb-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display text-2xl font-bold mb-2", children: [
                "Thank You, ",
                reflectionName || "Student",
                "!"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Your reflection has been recorded. Keep exploring and questioning!" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleReflectionSubmit, className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "ref-name", children: "Your Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "ref-name",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "ref-learned", children: "What did you learn today?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                id: "ref-learned",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Rate your understanding (1\\u20135)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Star,
                  {
                    className: `w-8 h-8 transition-colors ${star <= (hoverRating || Number(reflectionRating)) ? "text-accent fill-current" : "text-muted-foreground"}`
                  }
                )
              },
              star
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Understanding Level" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              RadioGroup,
              {
                ...
                children: ["1", "2", "3", "4", "5"].map((val) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    RadioGroupItem,
                    {
                      value: val,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: `rating-${val}`, children: [
                    val,
                    " \\u2014",
                    " ",
                    [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "ref-questions", children: "Any questions remaining?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                id: "ref-questions",
...
const emWaves = [
  {
    ...
    description: "Used in AM/FM radio, TV broadcasting, and mobile communications.",
    applications: [
      "AM/FM Radio",
      "Television",
      "Mobile phones",
  ...
  },
  {
    ...
    description: "Used in microwave ovens, radar systems, and Wi-Fi technology.",
  ...
  },
  {
    ...
    description: "Also called heat waves. Used in remote controls, thermal imaging, and night-vision.",
    applications: [
      "TV remotes",
      "Thermal cameras",
      "Night vision",
  ...
  },
  {
    ...
    production: "Electrons in atoms emit light when moving between energy levels",
    detection: "The eye, Photocells, Photographic film",
    color: "bg-yellow-50 border-yellow-300",
    badge: "bg-yellow-100 text-yellow-800",
    description: "The only part of the EM spectrum visible to the human eye — VIBGYOR.",
  ...
  },
  {
    ...
    description: "Used in sterilization, LASIK surgery, and security markings. Mostly absorbed by ozone layer.",
    applications: [
      "LASIK surgery",
      "Sterilization",
      "Vitamin D synthesis",
  ...
  },
  {
    ...
    description: "Penetrate soft tissue but are absorbed by bones — widely used in medical diagnostics.",
    applications: [
      "Medical imaging",
      "Crystallography",
      "Airport security",
  ...
  },
  {
    ...
    description: "Highest energy EM waves, produced in nuclear reactions. Used in cancer treatment.",
    applications: [
      "Cancer treatment",
      "Nuclear medicine",
      "Food irradiation",
...
function LearningConcepts() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "concepts.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/20 text-accent border-accent/40 mb-4", children: "Learning Concepts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl font-bold mb-4", children: "The Electromagnetic Spectrum" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg max-w-2xl", children: "A comprehensive overview of all 7 types of electromagnetic waves — their properties, production, detection, and real-world applications." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl px-4 py-12 space-y-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-4", children: "Table 8.1 — EM Wave Types" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl overflow-hidden border border-border shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-primary/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-bold", children: "Type" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-bold", children: "Wavelength Range" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-bold", children: "Production" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-bold", children: "Detection" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: emWaves.map((wave, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            TableRow,
            {
              className: idx % 2 === 0 ? "bg-background" : "bg-secondary/50",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-semibold", children: wave.type }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-sm", children: wave.wavelength }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-muted-foreground", children: wave.production }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-muted-foreground", children: wave.detection })
              ]
            },
            wave.type
          )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-6", children: "Individual Wave Types" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6", children: emWaves.map((wave) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: wave.type }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `text-xs ${wave.badge}`, children: wave.wavelength })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-3", children: wave.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-2", children: "Applications" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: wave.applications.map((app) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
...
function References() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "references.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/20 text-accent border-accent/40 mb-4", children: "Bibliography" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl font-bold mb-4", children: "References & Resources" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg", children: "Academic sources, textbooks, and digital resources used in preparing this lesson on Electromagnetic Waves." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl px-4 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: references.map((ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: `shadow-card border-l-4 ${ref.color} wave-card`,
          "data-ocid": `references.item.${ref.id}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary flex-shrink-0", children: ref.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `text-xs ${ref.badge}`, children: ref.type }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: ref.year })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-1", children: ref.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-2", children: ref.authors }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 bg-secondary rounded-xl p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold mb-4", children: "Suggested Further Reading" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: furtherReading.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "li",
          {
...
const summaryPoints = [
  {
    ...
    content: "Maxwell found an inconsistency in Ampere's circuital law when applied to time-varying electric fields. He introduced the concept of displacement current to resolve this: i_d = ε₀ dΦ_E/dt",
  ...
  },
  {
    ...
    content: "Electromagnetic waves are produced by accelerating electric charges. An oscillating charge with frequency ν produces EM waves of the same frequency ν. The energy comes from the kinetic energy of the oscillating charge.",
    formula: null,
  ...
  },
  {
    ...
    content: "EM waves were first produced experimentally by Heinrich Hertz in 1887, verifying Maxwell's equations. He used an oscillating electric spark to generate radio waves and detected them with a wire loop receiver.",
    formula: null,
  ...
  },
  {
    ...
    content: "In an EM wave, the electric field E and magnetic field B oscillate sinusoidally. They are perpendicular to each other and to the direction of propagation. Both fields are always in phase with each other.",
  ...
  },
  {
    ...
    content: "The speed of electromagnetic waves in vacuum equals the speed of light. This was one of Maxwell's most profound predictions — light itself is an electromagnetic wave.",
  ...
  },
  {
    ...
    content: "The EM spectrum stretches over an infinite range of wavelengths — from 10⁻² Å (gamma rays) to 10⁶ m (radio waves). All types travel at the same speed c in vacuum but differ in frequency and wavelength.",
...
function Summary() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "summary.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/20 text-accent border-accent/40 mb-4", children: "Chapter Summary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl font-bold mb-4", children: "Key Takeaways" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg", children: "Six essential points that capture the essence of Electromagnetic Waves — Chapter 8, Physics Class 12." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl px-4 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6", children: summaryPoints.map((point) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg mb-2", children: point.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-3", children: point.content }),
              point.formula && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/5 border border-primary/20 rounded-lg p-3 font-mono text-sm font-semibold text-primary text-center", children: point.formula })
            ] })
          ] }) })
        },
        point.number
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 bg-accent/10 border border-accent/30 rounded-xl p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold mb-3", children: "Remember" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "All electromagnetic waves — from low-frequency radio waves to high-frequency gamma rays — are fundamentally the same phenomenon. They are all transverse waves consisting of oscillating electric and magnetic fields, all traveling at the speed of light (c = 3×10⁸ m/s) in vacuum. What differs is only their frequency (and hence wavelength), which determines their energy and how they interact with matter." })
      ] })
    ] })
  ] });
}
...
function TopicOverview() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "topic.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/20 text-accent border-accent/40 mb-4", children: "Chapter 8 \\u00b7 Physics Class 12" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl font-bold mb-4", children: "Electromagnetic Waves" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg max-w-2xl", children: "Exploring the nature, production, and properties of electromagnetic waves \\u2014 from Maxwell's revolutionary prediction to Hertz's experimental verification." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-4xl px-4 py-12 space-y-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "topic.section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-4", children: "What are Electromagnetic Waves?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Electromagnetic waves are waves produced by the combined oscillation of electric and magnetic fields that are perpendicular to each other and to the direction of propagation. Unlike mechanical waves, they do not require a medium and can travel through vacuum at the speed of light." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "They carry energy and momentum from one place to another, and are fundamental to technologies like radio communication, medical imaging, and wireless internet." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-6", children: "Maxwell's Contribution" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Inconsistency in Ampere's Law" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground leading-relaxed", children: [
              "James Clerk Maxwell (1831\\u20131879) discovered that Ampere's circuital law was inconsistent for time-varying electric fields. He introduced the concept of",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "displacement current" }),
              " to resolve this inconsistency."
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card bg-primary/5 border-primary/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Displacement Current Formula" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-lg font-bold text-center py-4 text-primary", children: [
                "i",
                /* @__PURE__ */ jsxRuntimeExports.jsx("sub", { children: "d" }),
                " = \\u03b5\\u2080 \\u00b7 d\\u03a6",
                /* @__PURE__ */ jsxRuntimeExports.jsx("sub", { children: "E" }),
                "/dt"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground text-center", children: [
                "Where \\u03b5\\u2080 is the permittivity of free space and \\u03a6",
                /* @__PURE__ */ jsxRuntimeExports.jsx("sub", { children: "E" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-4", children: "How are EM Waves Produced?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-secondary rounded-xl p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: productionPoints.map((point, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-7 h-7 rounded-full bg-primary/20 text-primary font-bold flex items-center justify-center text-sm flex-shrink-0", children: i + 1 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground leading-relaxed", children: point })
        ] }, point)) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-4", children: "Hertz's Experiment (1887)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Heinrich Hertz experimentally verified Maxwell's prediction in 1887. He used an oscillating electric spark between two metallic spheres to produce radio waves and detected them with a receiver loop some distance away \\u2014 confirming that EM waves travel at the speed of light." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4", children: hertzPoints.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-accent/10 border border-accent/20 rounded-xl p-4",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-accent-foreground mb-2", children: item.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold mb-6", children: "Properties of EM Waves" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold mb-3", children: "Electric & Magnetic Fields" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "\\u2022 E and B fields oscillate sinusoidally" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "\\u2022 E \\u22a5 B (perpendicular to each other)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "\\u2022 Both perpendicular to direction of propagation" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "\\u2022 E and B are always in phase" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-card bg-primary/5 border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold mb-3", children: "Speed & Relationships" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-center py-2 text-primary font-bold", children: "c = 1/\\u221a(\\u03bc\\u2080\\u03b5\\u2080)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-center py-2 text-primary font-bold", children: "E\\u2080/B\\u2080 = c = 3\\u00d710\\u2078 m/s" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center", children: "\\u03bc\\u2080 = 4\\u03c0\\u00d710\\u207b\\u2077 T\\u00b7m/A, \\u03b5\\u2080 = 8.85\\u00d710\\u207b\\u00b9\\u00b2 C\\u00b2/N\\u00b7m\\u00b2" })
            ] })
          ] }) })
        ] })
      ] })
...
function App() {
  const [currentPage, setCurrentPage] = reactExports.useState("about");
  const navigate = (page) => {
    setCurrentPage(page);
    window.scrollTo({ top: 0, behavior: "smooth" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { currentPage, onNavigate: navigate }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      currentPage === "about" && /* @__PURE__ */ jsxRuntimeExports.jsx(AboutMe, { onNavigate: navigate }),
      currentPage === "topic" && /* @__PURE__ */ jsxRuntimeExports.jsx(TopicOverview, {}),
      currentPage === "concepts" && /* @__PURE__ */ jsxRuntimeExports.jsx(LearningConcepts, {}),
      currentPage === "activities" && /* @__PURE__ */ jsxRuntimeExports.jsx(ActivitiesStrategies, {}),
      currentPage === "assessment" && /* @__PURE__ */ jsxRuntimeExports.jsx(AssessmentReflection, {}),
      currentPage === "summary" && /* @__PURE__ */ jsxRuntimeExports.jsx(Summary, {}),
      currentPage === "references" && /* @__PURE__ */ jsxRuntimeExports.jsx(References, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-primary-foreground py-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm opacity-80", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Talari Jyothsna. Built with love using",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
